...
- Critical systems: deployment output generation (`hugo --destination docs`), CI pipeline (`.github/workflows/ci.yml`, `.github/workflows/deploy-pages.yml`), Dockerized runtime and validation (`Dockerfile`, `docker-compose.yml`).
